...
| 🎼 **Théorie** | Comment on construit une gamme — les intervalles W (un ton) et H (un demi-ton), A mineur et A majeur côte à côte — puis un jeu où il faut retrouver les six notes d'une gamme à partir de sa fondamentale et de son type. Comment on construit un accord — on saute une note sur deux dans la gamme (A C E → Am, puis Am7) — avec son propre jeu : la fondamentale est donnée, on complète la triade ou l'accord de septième. La pentatonique — la gamme mineure moins le 2ᵉ et le 6ᵉ degré — avec quatre jeux : barrer les deux intruses, trouver la penta, la relative majeure ou mineure, et poser la boîte position 1 sur le manche. Les boîtes 1 et 4 de A mineur, chacune sur son manche, avec la piste d'improvisation du cours et un exercice pour les travailler. |
